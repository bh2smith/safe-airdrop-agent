...
import drainRouter from "./api/tools/drain.js";
import multisendRouter from "./api/tools/multisend.js";
...
// Tool Routes
app.use("/api/tools/drain", drainRouter);
app.use("/api/tools/multisend", multisendRouter);
